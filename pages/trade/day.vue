        ...
        <el-dialog
            ...
            <div class="confirm_financing-content">
                <ul>
                    ...
                    <li>
                        <span>合约产品：</span>
                        <span>T{{selectProduct.product_times}}</span>
                    </li>
                    <li>
                        <span>保证金：</span>
                        <span>{{amount}}</span>
            ...
            <div class="confirm_financing">
                <div class="success_financing-content">
                    <ul>
                        ...
                        <li>
                            <span>合约产品：</span>
                            <span>T{{selectProduct.product_times}}—{{id}}</span>
                        </li>
                    </ul>
                    <p>
                        提示：
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getProduct() {
                this.productData = getItem("products")[1]
        ...
        computed: {
            ...
            total() {
                if (this.amount >= this.minPut && this.rate) {
                    return Number(this.amount) + this.manageCost * 2
                } else {
                    return "--"
                }
            },
