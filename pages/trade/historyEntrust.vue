                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr v-for="item in stocksData">
                            ...
                            <td class="">
                                <span v-if="item.sold_or_buy==2" class="fontBlue">卖出</span>
                                <span v-if="item.sold_or_buy==1" class="fontRed">买入</span>
                            </td>
...
<script>
    import {getStockFinances, getEntrustsHistory} from "../../api/trade";
    ...
    methods: {
        ...
        getData(){
            let _this = this
            getEntrustsHistory(_this.stockPage, {id: _this.stockId}).then(function (data) {
                if(data.status){
