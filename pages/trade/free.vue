    ...
    <div class="day_page">
        <div class="buy_amount">
            ...
            <div>
                ...
                <div class="scan_amount" v-if="showScanInput">
                    <input type="text" v-model="scanAmount" placeholder="200元-500万元，100的整数倍" @input="changeAmount(1)">
                </div>
            </div>
        ...
        <div class="financing_params">
            <ul>
                ...
                <li>
                    <span>到期过夜费</span>
                    <span>{{manageCost}}/交易日×2</span>
                    <span>前2个交易日免息，第三个交易日起收取到期过夜费</span>
                </li>
            </ul>
        </div>

        <div class="financing_total" v-if="false">
            <ul>
                <li>
                    <span>优惠券</span>
                    <div>
                    ...
                    <span v-if="selectDiscount">
                        优惠券余额 {{selectDiscountData.remain_discount}}
                    </span>
                    <span v-if="selectDiscount">
                        到期日期 {{selectDiscountData.valid_end_time}}
                    </span>
                </li>
        ...
        <el-dialog
            ...
            <div class="confirm_financing-content">
                <ul>
                    ...
                    <li>
                        <span>合约产品：</span>
                        <span>{{selectProduct.product_name}}</span>
                    </li>
                    <li>
                        <span>保证金：</span>
                        <span>{{amount}}</span>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="confirmFinancing = false">取 消</el-button>
                <el-button type="primary" @click="stockFinance()" :disabled="isSubmitting">确 定</el-button>
            </span>
        </el-dialog>
            ...
            <div class="confirm_financing">
                <div class="success_financing-content">
                    <ul>
                        ...
                        <li>
                            <span>合约产品：</span>
                            <span>{{selectProduct.product_name}}—{{id}}</span>
                        </li>
                    </ul>
                    <p>
                        提示：
        ...
        <el-dialog
            ...
            <div class="balance_pay_mention">
                ...
                <div class="charge_box ">
                    ...
                    <span class="">{{manageCost * 2}}元</span>
                </div>
                <div class="charge_box ">
                    <span class="">总费用：</span>
...
<script>
    ...
    import {getStockFinance, getStockFinances, stockFinance} from "../../api/trade";
    ...
    export default {
        ...
        methods: {
            ...
            getProduct() {
                this.productData = getItem("products")[5]
