...
<script>
    ...
    import {getSms, updatePassword} from "../../api/personal";
    ...
    export default {
        ...
        methods: {
            ...
            updatePwd(){
                ...
                updatePassword({phoneCode: _this.formData.phoneCode, password:crypt.encrypt(_this.formData.password)}).then(function (data) {
                    if(data.status){
                        successMsg("更新密码成功");
